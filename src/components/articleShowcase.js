            ...
            <div className="articleDisplayContainer">
              <div className="articleDisplayContent">
                ...
                <p className="articleDisplayArticle">
                  ...
                  interesting. Especially the fact that we still don’t really
                  know how these things were built. There’s dozens of ideas
                  ranging from aliens to levitation. A lot of researchers have
                  developed theories over the years to answer the question: How
                  did the Egyptians built these magnificent pyramids?
                </p>
                <button className="articleDisplayReadMoreButton">
                  Read More
                </button>
              </div>
            </div>
